...
public class ShoppingCartServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       // CartLocal cart = (CartLocal) request.getSession().getAttribute(CART_SESSION_KEY);
        cart = (Cart) request.getSession().getAttribute(CART_SESSION_KEY);
        if(cart == null) {
            try {
                InitialContext ic = new InitialContext();
               // cart = (CartLocal) ic.lookup("java:global/EJB_statefulbean-ejb/Cart!ejb.CartLocal");
                cart = new Cart();
                request.getSession().setAttribute(CART_SESSION_KEY, cart);
